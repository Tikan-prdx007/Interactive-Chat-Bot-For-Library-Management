...
const VoiceModule = (() => {
    ...
    function render() {
      ...
      <div class="panel-header">
        <h2>🎤 Voice Mode</h2>
        <p class="panel-sub">Speak to LibraMate hands-free</p>
      </div>
      ...
      <div class="voice-response-wrap">
        <div class="voice-label">🤖 LibraMate's Response</div>
    ...
    function processVoiceInput(text) {
        ...
        if (responseEl) {
            responseEl.innerHTML = `<strong>You said:</strong> "${text}"<br><br><strong>LibraMate:</strong> ${reply.text}`;
        }
